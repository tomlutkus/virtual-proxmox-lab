#!/usr/bin/env bash
#
# Script: deploy_pve-03.sh
# Purpose: Standalone deployment script for pve-03 VM
# 
...
virt-install \
  ...
  --network bridge=virbr0,model=virtio,mac=02:00:00:00:01:03 \
  --network bridge=vm-br,model=virtio,mac=02:00:00:01:01:03 \
  --network bridge=ha-br,model=virtio,mac=02:00:00:FD:01:03 \
  --network bridge=ceph-br,model=virtio,mac=02:00:00:FE:01:03 \
  --network bridge=st-br,model=virtio,mac=02:00:00:FF:01:03
