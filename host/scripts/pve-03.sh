...
virt-install \
  ...
  --network bridge=virbr0,model=virtio,mac=52:54:00:01:03:03 \
  --network bridge=vm-br,model=virtio,mac=02:00:00:01:03:03 \
  --network bridge=ha-br,model=virtio,mac=02:00:00:FD:03:03 \
  --network bridge=ceph-br,model=virtio,mac=02:00:00:FE:03:03 \
  --network bridge=st-br,model=virtio,mac=02:00:00:FF:03:03
